   ...
   return (
      <div className="lg:w-72 shrink-0 flex flex-col gap-4 lg:sticky lg:top-24 lg:self-start lg:max-h-[calc(100vh-6rem)] lg:overflow-y-auto">
               ...
               <div className="flex flex-col gap-2">
                  {[
                     ...
                     <div key={label} className="flex items-center justify-between py-2 border-b border-base-200 last:border-0">
                        <span className="text-xs opacity-40 flex items-center gap-1"><FiClock size={10} /> {label}</span>
            ...
            <div className="bg-base-100 border border-base-200 rounded-2xl shadow-sm overflow-hidden">
               ...
               <div className="p-5 flex flex-col gap-4">
                  ...
                  <div className="bg-base-200/50 rounded-xl p-3 border border-base-200 flex flex-col gap-2">
                     {teacher.phoneNumber && <div className="flex items-center gap-2"><FiPhone size={11} className="opacity-40 shrink-0" /><span className="text-xs font-semibold">{teacher.phoneNumber}</span></div>}
                     {teacher.email && <div className="flex items-center gap-2"><FiMail size={11} className="opacity-40 shrink-0" /><span className="text-xs font-semibold truncate">{teacher.email}</span></div>}
                  </div>
               </div>
            </div>
         )}
         ...
         <div className="bg-base-100 border border-base-200 rounded-2xl shadow-sm p-5">
            <div className="text-xs font-semibold opacity-40 mb-3 flex items-center gap-1"><PiStudent size={12} /> Şagird sayı</div>
