            ...
            <div className="p-6 flex flex-col gap-5">
               ...
               <div className="flex flex-col gap-3">
                  <div className="flex flex-col gap-1">
                     ...
                     <input type="text" value={form.profession} onChange={e => onFormChange('profession', e.target.value)}
                  ...
                  <div className="flex gap-3">
                     <div className="flex flex-col gap-1 flex-1">
                        ...
                        <input type="number" value={form.groupNumber} onChange={e => onFormChange('groupNumber', e.target.value)}
                           className="input w-full pl-4 pr-4 py-2.5 rounded-xl border border-base-200 bg-base-200/50 focus:outline-none focus:border-[#8B5CF6] transition-all duration-200 text-sm" />
                     </div>
                     <div className="flex flex-col gap-1 flex-1">
