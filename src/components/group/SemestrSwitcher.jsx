...
function SemestrSwitcher({ currentSemestr, shownSemestr, semestrs, onSelect }) {
   const [showOld, setShowOld] = useState(false);

   const hasOld = semestrs.length > 1;
   const oldSemestrs = semestrs.filter(s => s !== currentSemestr);
