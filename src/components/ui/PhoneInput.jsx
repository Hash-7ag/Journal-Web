  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <div className="relative group flex items-stretch">
        ...
        <div className="flex items-center gap-1.5 px-3.5 rounded-l-xl border-2 border-r-0 border-base-200/80 bg-base-200/60 text-sm font-bold text-base-content/60 group-focus-within:border-[#8B5CF6] transition-colors duration-200 shrink-0">
        ...
        <input
          ...
          className={`flex-1 min-w-0 pl-3 pr-4 py-3 rounded-r-xl bg-base-100 border-2 border-base-200/80
