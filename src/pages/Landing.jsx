...
function Landing() {
  ...
  const features = [
    {
      ...
      title: 'Şagird bazası',
      desc: 'Bütün şagirdlərin vahid məlumat bazasının yaradılması və idarəsi.',
      color: 'from-[#8B5CF6] to-[#3B82F6]',
    },
    {
      icon: <FiUsers size={20} />,
      title: 'Müəllim bazası',
      desc: 'Bütün müəllimlərin məlumat bazasının yaradılması və izlənməsi.',
      color: 'from-[#3B82F6] to-[#60A5FA]',
    },
    {
      icon: <FiBook size={20} />,
      title: 'Fənlərin idarəsi',
      desc: 'Fənlərin yaradılması və onların müəllimlərə təyin edilməsi.',
      color: 'from-[#8B5CF6] to-[#A78BFA]',
    },
    {
      icon: <FiLayers size={20} />,
      title: 'Qrupların idarəsi',
      desc: 'Qrupların yaradılması, şagird və fənlərlə tam idarəetmə.',
      color: 'from-[#6366F1] to-[#8B5CF6]',
    },
    {
      icon: <FiSliders size={20} />,
      title: 'Çevik tənzimləmə',
      desc: 'Bütün məlumatları asanlıqla dəyişmək və uyğunlaşdırmaq imkanı.',
      color: 'from-[#3B82F6] to-[#8B5CF6]',
    },
    {
      icon: <FiClipboard size={20} />,
      title: 'Müəllim paneli',
      desc: 'Müəllimlər üçün dərs, qiymət və davamiyyət idarəetmə sistemi.',
      color: 'from-[#A78BFA] to-[#60A5FA]',
    },
    {
      icon: <FiEye size={20} />,
      title: 'Şagird girişi',
      desc: 'Şagirdlərin öz məlumatlarını və qiymətlərini izləmə imkanı.',
      color: 'from-[#8B5CF6] to-[#3B82F6]',
    },
  ];
  ...
  const socials = [
    ...
    {
      label: 'Instagram',
      href: 'https://www.instagram.com/explore/locations/1026288168/mdniyyt-v-sntkarliq-uzr-baki-dovlt-pes-thsil-mrkzi/',
    },
  ];
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden">
      ...
      <section className="relative px-6 pt-20 pb-24 flex flex-col items-center text-center">
        ...
        >
          Təhsil müəssisəsinin elektron idarəetmə platforması — şagirdlər, müəllimlər, qruplar, fənlər, qiymətlər və
          davamiyyət bir sistemdə.
        </p>
          ...
          {features.map((f, i) => (
            <Reveal key={f.title} delay={i * 80}>
              <div className="group h-full bg-base-100/60 backdrop-blur-md border border-base-200/80 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 hover:border-[#8B5CF6]/30 transition-all duration-300">
                <div
                  className={`w-12 h-12 rounded-xl bg-gradient-to-br ${f.color} flex items-center justify-center text-white shadow-md mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
                  {f.icon}
                </div>
        ...
        <Reveal>
          <div className="bg-base-100/60 backdrop-blur-md border border-base-200/80 rounded-3xl overflow-hidden shadow-lg">
            ...
            <div className="p-8 sm:p-10 flex flex-col gap-6">
              <div>
                <span className="text-xs font-semibold uppercase tracking-widest text-[#8B5CF6] opacity-70">
                  Haqqında
                </span>
              ...
              <p className="text-sm opacity-50 leading-relaxed">
                E-Cədvəl platforması hazırda Mədəniyyət və Sənətkarlıq üzrə Bakı Dövlət Peşə Təhsil Mərkəzinin
                sərəncamındadır və mərkəzin gündəlik idarəetmə proseslərini rəqəmsallaşdırmaq üçün hazırlanmışdır.
              </p>
            </div>
          </div>
        </Reveal>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          {developers.map((dev, i) => (
            <Reveal key={dev.name} delay={i * 100}>
              <div
                className={`group relative h-full bg-base-100/60 backdrop-blur-md border border-base-200/80 rounded-2xl p-6 flex flex-col items-center text-center shadow-sm hover:-translate-y-1.5 transition-all duration-300 ${dev.glow}`}
              >
                {/* Area badge */}
                <div
                  className={`absolute top-4 right-4 flex items-center gap-1 px-2.5 py-1 rounded-full border text-[11px] font-semibold ${dev.badge}`}
                >
                  {dev.icon}
                  {dev.area}
                </div>
                ...
                {/* Avatar */}
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${dev.color} flex items-center justify-center text-white text-xl font-bold shadow-md mb-4 mt-2 group-hover:scale-110 transition-transform duration-300`}
                >
                  {dev.initials}
                </div>
      ...
      <section className="relative px-6 py-16 max-w-4xl mx-auto">
        <Reveal>
          ...
          >
            ...
            <FiExternalLink
              size={18}
              className="opacity-30 group-hover:opacity-70 transition-opacity duration-300 shrink-0"
            />
          </a>
        </Reveal>
      </section>
