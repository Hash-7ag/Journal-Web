                     ...
                     <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                           ...
                           <div>
                              ...
                              <p className="text-xs opacity-40">{editModal.profession}</p>
                           </div>
                        </div>
                        ...
                        <div className="flex gap-3">
                           <div className="flex flex-col gap-1 flex-1">
                              ...
                              <input
                                 ...
                                 onChange={e => setEditForm(p => ({ ...p, groupNumber: e.target.value }))}
                                 className="input w-full pl-4 pr-4 py-2.5 rounded-xl border border-base-200 bg-base-200/50 focus:outline-none focus:border-[#8B5CF6] transition-all duration-200 text-sm"
                              />
                           </div>
                           <div className="flex flex-col gap-1 flex-1">
                              ...
                              <input
                                 type="number"
                                 value={editForm.groupShifr}
                                 onChange={e => setEditForm(p => ({ ...p, groupShifr: e.target.value }))}
                                 className="input w-full pl-4 pr-4 py-2.5 rounded-xl border border-base-200 bg-base-200/50 focus:outline-none focus:border-[#8B5CF6] transition-all duration-200 text-sm"
                              />
                           </div>
                        </div>
