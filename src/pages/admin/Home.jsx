...
import { FiUser, FiPhone, FiMail, FiShield, FiEdit2, FiX, FiCheck } from 'react-icons/fi';
...
function Home() {
   ...
   const handleEditSubmit = async () => {
      try {
         setSubmitting(true);
         setEditError('');
         await api.patch('/admin/updateMyInfo', {
            ...editForm,
                     ...
                     <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="flex flex-col gap-1 col-span-2">
                           ...
                           <div className="relative">
                              ...
                              <input
                                 type="tel"
                                 value={editForm.phone || '+994 '}
                                 onChange={e => setEditForm(p => ({ ...p, phone: formatPhone(e.target.value) }))}
                                 onFocus={() => {
                                    if (!editForm.phone) setEditForm(p => ({ ...p, phone: '+994 ' }));
                                 }}
