...
import { FiPlus, FiUser, FiMail, FiPhone, FiLock } from 'react-icons/fi';
...
function Students() {
   ...
   const handleAddStudent = async () => {
      ...
      try {
         setSubmitting(true);
         const response = await api.post('/admin/createStudent', formData);
      ...
      <div className="min-h-[calc(100vh-4rem)] px-6 py-8">
         ...
         <div className="flex justify-between items-center mb-8">
            <div>
               ...
               <p className="text-xs opacity-40 mt-0.5">Bütün şagirdlərin siyahısı</p>
            </div>
            <button
         ...
         {students.length === 0 ? (
            ...
            <div className="flex flex-col gap-3">
               {students.map((student, index) => {
                  const colorClass = studentColors[index % studentColors.length];
                     ...
                     >
                        ...
                        <div className="flex-1 min-w-0">
                           ...
                           <div className="text-xs opacity-40 mt-0.5 truncate">
                              ...
                              {student.group && (
                                 <span className="ml-2 px-1.5 py-0.5 rounded-md bg-base-200 text-xs font-mono">
                                    {student.group}
                                 </span>
                              )}
                           </div>
