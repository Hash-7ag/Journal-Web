      ...
      <div>
         <ul className="list bg-base-100 rounded-box shadow-md">
            <li className="tracking-wide flex justify-between items-center">
               <span className="p-4 pb-2 text-xs opacity-60">All Students List</span>
               <button
            ...
            {students.length === 0 ? (
               ...
               students.map((student, index) => (
                  <li className="list-row mt-2 mb-6 mx-10 shadow-md" key={student._id || index}>
                     <div>
                        <img
                     ...
                     <div>
                        ...
                        <div className="text-xs uppercase font-semibold opacity-60">{student.group || '—'}</div>
                     </div>
