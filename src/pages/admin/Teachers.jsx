      ...
      <div className="min-h-[calc(100vh-4rem)] px-6 py-8">
         ...
         <div className="flex justify-between items-center mb-8">
            <div>
               ...
               <p className="text-xs opacity-40 mt-0.5">Bütün müəllimlərin siyahısı</p>
            </div>
            <button
         ...
         {teachers.length === 0 ? (
            ...
            <div className="flex flex-col gap-3">
               {teachers.map((teacher, index) => {
                  const colorClass = teacherColors[index % teacherColors.length];
                     ...
                     >
                        ...
                        <div className="flex-1 min-w-0">
                           ...
                           <div className="text-xs opacity-40 mt-0.5 truncate">
                              {teacher.fatherName && `${teacher.fatherName} oğlu`}
                           </div>
                        </div>
