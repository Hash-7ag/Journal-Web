...
function Login() {
  ...
  const login = async () => {
    ...
    try {
      ...
      setServerError(error.response?.data?.message || 'Uğursuz giriş. Yenidən cəhd edin.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="bg-base-100 rounded-2xl shadow-lg border border-base-200 overflow-hidden">
          ...
          <div className="p-8 flex flex-col gap-6">
            ...
            <div className="flex flex-col items-center gap-2 text-center">
              <div
                className={`w-12 h-12 rounded-xl bg-gradient-to-br ${gradientClass} flex items-center justify-center text-white shadow-md`}
              >
                <FiUser size={20} />
              </div>
              <h2 className="text-xl font-bold">{roleLabel} kimi daxil ol</h2>
              <p className="text-xs opacity-40">Hesabınıza daxil olmaq üçün məlumatları doldrun</p>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-1">
                <label className="text-xs font-medium opacity-60 ml-1">İstifadəçi adı</label>
