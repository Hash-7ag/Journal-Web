                  ...
                  return (
                     <div key={group._id} className="bg-base-100 border border-base-200 rounded-2xl shadow-sm overflow-hidden">
                        ...
                        <div className="px-5 py-4 flex items-center gap-4 border-b border-base-200">
                           <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${groupColor} flex items-center justify-center text-white font-bold text-lg shadow-md shrink-0`}>
                              {group.groupNumber}
                           </div>
                              ...
                              mySubjects.map((item, subIndex) => {
                                 ...
                                 return (
                                    <button
                                       ...
                                       className="group w-full flex items-center gap-4 px-4 py-3 rounded-xl border border-base-200 hover:border-[#8B5CF6]/30 hover:bg-base-200/30 hover:shadow-sm transition-all duration-200 text-left"
                                    >
                                       <div className={`w-9 h-9 rounded-lg bg-gradient-to-br ${subColor} flex items-center justify-center text-white shadow-sm shrink-0`}>
                                          <FiBook size={14} />
                                       </div>
                                       <div className="flex-1 min-w-0">
                                          ...
                                          <div className="flex items-center gap-3 mt-0.5">
                                             ...
                                             {subject.kredit && (
                                                <span className="text-xs opacity-40">{subject.kredit} kredit</span>
                                             )}
                                             {subject.totalHours && (
                                       ...
                                       <FiArrowRight size={14} className="opacity-20 group-hover:opacity-60 transition-opacity duration-200 shrink-0" />
                                    </button>
                                 );
                              })
                           )}
